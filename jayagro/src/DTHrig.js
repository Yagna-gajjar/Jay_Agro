...
export default function DTHrig() {
    ...
    let FormatedDetails = dth.map((e) => {
        return (
            <Link to={"/dthdetails/" + e.dthname} class="m-sm-4 col-lg col-sm-12 border border-2 border-black" id="dthLink">
                <img src={require('./img/DTH.png')} class="img-fluid" />
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-2">
                            <Link to={"/dthdetails/" + e.dthname} class="btn btn-warning btn-block text-truncate">View more</Link>
                        </div>
                    </div>
                </div>
            </Link >
